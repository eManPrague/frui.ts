...
export abstract class ValidationControlBase<TTarget, OtherProps = {}> extends BindingComponent<
  ExcludeBindingProps<CommonInputProps & OtherProps> & IBindingProps<TTarget>,
  TTarget
> {
  render() {
