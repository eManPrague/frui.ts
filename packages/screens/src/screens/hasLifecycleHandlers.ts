...
export type RequiredLifecycleEvents<TScreen = unknown, TNavigationParams = unknown, TLocation = unknown> = Required<
  HasLifecycleEvents<TScreen, TNavigationParams, TLocation>
>;
